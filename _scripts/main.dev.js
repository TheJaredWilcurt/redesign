...
//                                                             //
/////////////////////////////////////////////////////////////////
// Targets the accordions on all pages for use by jQuery. Auto //
// opens accordions to correct section.                        //
/////////////////////////////////////////////////////////////////
...
$(function() {
    ...
    $( "#ResourcesBox" ).accordion();

    var allSections = $.makeArray($("#MainSideBar > h3"));
    var selectedSection = $("#MainSideBar > h3.selected")[0];
    var selectedIndex = allSections.indexOf(selectedSection);
    $("#MainSideBar").accordion( "option", "active", selectedIndex);
});
